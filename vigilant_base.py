...
class Vigilant(Optimizer):
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            step_factor_over_sample_size = step_factor / sample_size_mean
            ...
            for p in group['params']:
                ...
                update.clamp_(-max_update_scaled, max_update_scaled)
                p.data.add_((
                    prev_update - (1.0 + step_decay) * update))
